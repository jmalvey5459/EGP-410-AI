...
{
	 Color colorBlack = BLACK_COLOR;
	 Color colorYellow = YELLOW_COLOR;
	 Color colorBlue = BLUE_COLOR;


	if( mDirty )
	{
		//remove old entries first
		removeAllEntriesOfColor(colorBlack);
		removeAllEntriesOfColor(colorYellow);
		removeAllEntriesOfColor(colorBlue);
